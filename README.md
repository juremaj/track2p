...
___
Note: We are very actively developing the software for the next couple of months, so we would greatly appreciate any feedback! (You can raise it as an ['issue'](https://github.com/juremaj/track2p/issues) on GitHub or contact us directly. Thanks!
___
