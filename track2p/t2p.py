...
def run_t2p(track_ops):
    ...
    print("plot_reg_img_output done")
    ...
    if track_ops.show_roi_reg_output:
        ...
        print("plot_roi_reg_output done")
    ...
    print("get_all_ds_assign done")
    plot_thr_met_hist(all_ds_thr_met, all_ds_thr, track_ops)
    print("plot_thr_met_hist done")
    ...
    print("get_all_pl_match_mat done")

    # 9) save results
    save_track_ops(track_ops)
    print("save_track_ops done")
    
    save_all_pl_match_mat(all_pl_match_mat, track_ops)
    print("save_all_pl_match_mat done")
